...
let currentTableSelected = document.querySelector(".destination-active");
...
tabs.forEach((tab) => {
  tab.addEventListener("click", () => {
    currentTableSelected.classList.remove("destination-active");
    tab.classList.add("destination-active");
    currentTableSelected = document.querySelector(".destination-active");
